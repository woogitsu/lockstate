...
- **Navigation caches and the pending path-request queue** (`RouteCache`,
  ...
  **Integration update, 2026-09-24:** after the intake work was combined with
  #1373, that 24-prisoner fixture still deferred five requests at tick 3462,
  but continuous and restored snapshots matched at ticks 3462 and 3463. The
  test now requires equality for that fixture. This does not prove that warm
  and cold navigation caches have equivalent service sets at every binding
  budget; ADR 0059's broader choice remains open.

...
> > `src/ui/hud/hud.ts:2987` (the anchor read 2957, then 2917, then 2611, then 2759, then 2837,
> > then 2887, then 2980; re-aimed onto the quoted line by `grep -n` rather than by

...
**Every ADR in this directory is accepted, and so is the one amendment that was
outstanding.** 0031, 0032, 0033 and ADR 0007's amendment were all approved on
2026-08-26, which emptied [`STATUS-QUEUE.md`](./STATUS-QUEUE.md) §2 for the third
time in its history.
...
| [0033](./0033-releasing-an-interrupted-incident-response-at-runtime.md) | A restored session abandons an incident response and returns what it claimed | Accepted, 2026-08-26 — with its open question 1 commissioned as work |

...
owned chunk and no parcels (`src/simulation/runtime/new-session.ts:280-282`). So
...
> `src/simulation/runtime/new-session.ts:437`, still followed immediately by the

...
(`src/simulation/economy/treasury.ts`, constructor, credit and restore; the
old anchors read `:73`, `:83`, `:120` and `:134`, all docblock lines in what is
now a 900-line file) and the save

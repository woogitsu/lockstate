...
`src/simulation/protocol/types.ts:2130-2159`; the correction under the table
...
> `src/simulation/protocol/types.ts:2082` and closes `] as const;` at `:2002`,
...
`roomNameKey: identifierSchema` (`src/simulation/protocol/types.ts:2455`) is
...
- **`:1864-1892` was right at `ca82e946` and is wrong at `460ef077`.** The
  ...
  reads `src/simulation/protocol/types.ts:2130-2159` with

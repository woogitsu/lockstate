...
| 0039 | `hud.rooms.catalogue` relabelled to name the numeric form too | `src/content/default-locale-en.ts:1539` reads `'Room type and area'` | TRUE (pixel/scroll-height measurements in the ADR were not re-measured this pass — READ only for those) |

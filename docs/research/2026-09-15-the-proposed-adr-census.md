...
| `src/ui/hud/projection.ts:959` | the line ending *"since ADR 0064 the state withholds part of the"* | **`:939`** |
| `src/ui/hud/projection.ts:1264-1266` | *"\* (#703 ruling A, ADR 0083 §2), so a purchase this thread refuses on money has"* | **`:1244-1246`** |

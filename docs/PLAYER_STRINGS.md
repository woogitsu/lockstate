...
| `hud.rooms.yard-guidance` | Yard needs 8 × 8 tiles. {zoom} shows more of the map; {coordinates} lets you set an area without dragging. | `src/content/default-locale-en.ts:3601` |
| `hud.rooms.yard-guidance-narrow` | Yard needs 8 × 8 tiles. Scroll down on the map or pinch on touch to zoom out; {coordinates} sets an area without dragging. | `src/content/default-locale-en.ts:3602` |

...
| `save.manage.title` | Saved prisons | `src/content/default-locale-en.ts:4115` |
| `save.manage.local` | On this device | `src/content/default-locale-en.ts:4116` |
| `save.manage.cloud-unavailable` | Cloud saves are unavailable in this version because the game has no cloud connection. | `src/content/default-locale-en.ts:4117` |

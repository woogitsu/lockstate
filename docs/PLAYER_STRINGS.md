...
| `hud.security.coverage-no-posts` | No posts | `src/content/default-locale-en.ts:3070` |
| `hud.security.coverage-no-posts-hint` | No guard posts are required right now. | `src/content/default-locale-en.ts:3071` |

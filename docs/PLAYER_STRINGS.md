...
| `save.default-prison-name` | New Prison | `src/content/default-locale-en.ts:4117` |
...
| `save.scope.prisoners` | prisoners, needs, actions and cell assignments | `src/content/default-locale-en.ts:4341` |

...
const authoredMessages: Readonly<Record<string, LocalizationEntry>> = {
  ...
  'hud.rooms.open-north-edge': 'Open edge above tile ({x}, {y}). Move the room or close that edge.',
  'hud.rooms.open-west-edge': 'Open edge left of tile ({x}, {y}). Move the room or close that edge.',

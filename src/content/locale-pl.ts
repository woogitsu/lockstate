...
const plMessages: Readonly<Record<string, LocalizationEntry>> = {
  ...
  'hud.rooms.open-north-edge': 'Otwarta krawędź nad polem ({x}, {y}). Przesuń pokój albo zamknij tę krawędź.',
  'hud.rooms.open-west-edge': 'Otwarta krawędź na lewo od pola ({x}, {y}). Przesuń pokój albo zamknij tę krawędź.',

...
const plMessages: Readonly<Record<string, LocalizationEntry>> = {
  ...
  'hud.rooms.yard-guidance': 'Plac spacerowy wymaga 8 × 8 pól. Przycisk „{zoom}” pokazuje więcej mapy; sekcja „{coordinates}” pozwala wyznaczyć obszar bez przeciągania.',
  'hud.rooms.yard-guidance-narrow': 'Plac spacerowy wymaga 8 × 8 pól. Przewiń w dół nad mapą albo użyj gestu szczypania, by oddalić widok; sekcja „{coordinates}” pozwala wyznaczyć obszar bez przeciągania.',

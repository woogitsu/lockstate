 ...
 * The twin laundry washer leaves the fallback with its own 2x1 model. Two
 * top-visible drum windows survive the straight-down camera, unlike the
 * front doors in its original oblique concept.
 */

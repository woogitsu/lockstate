 ...
 * A separate 2x1 food-preparation counter now leaves it as well: the cutting
 * board and three ingredient wells are visible from directly overhead. The
 * earlier shipping-container substitution remains rejected.
 */

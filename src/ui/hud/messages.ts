...
export const HUD_MESSAGE_KEY = {
  ...
  regimeRiskBadgeName: 'hud.regime.risk-badge-name',
  regimeRiskExplanation: 'hud.regime.risk-explanation',
  regimeRiskMediumSchedule: 'hud.regime.risk-medium-schedule',

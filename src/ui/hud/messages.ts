...
export const HUD_MESSAGE_KEY = {
  ...
  securityCoverageNoReserve: 'hud.security.coverage-no-reserve',
  securityCoverageNoReserveHint: 'hud.security.coverage-no-reserve-hint',
  securityCoverageNoReserveConsequence: 'hud.security.coverage-no-reserve-consequence',
  ...
  roomsMealPortions: 'hud.rooms.meal-portions',

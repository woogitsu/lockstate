...
/** Apply the approved facility to the grant used to open this treasury (#976, PR #1405). */
...
export function createNewSimulationRuntime(masterSeed: number = 0, options: SimulationRuntimeOptions = {}): SimulationRuntime {
   ...
   * §2). `createOpeningTreasury` derives the approved one-tenth facility from
   * the opening grant actually supplied.
   *

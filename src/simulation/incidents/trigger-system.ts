    ...
    this.openIncident(
      {
        ...
        severity: Math.max(1, Math.min(INCIDENT_SEVERITY_CEILING, Math.round(candidate.score * 10))),
        causeFactors: [
    ...
    this.openIncident(
      {
        ...
        severity: Math.max(1, Math.min(INCIDENT_SEVERITY_CEILING, Math.round(score * 10))),
        causeFactors,
      },
      tick,
    );

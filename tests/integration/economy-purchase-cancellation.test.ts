...
describe('cancelling a purchase whose delivery has not landed', () => {
  it('pins the two figures every balance below is written from', () => {
    ...
    //
    // The grant was 25,000 and every balance in this file read 75,000 lower
    // until the owner's ruling of 2026-09-23 set it to 100,000 (#641). No
    // case here goes near the floor, so the differences are unchanged.

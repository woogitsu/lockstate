 ...
 *
 * `100_000` is the opening grant since the owner's ruling of 2026-09-23 (#641);
 * it read `25_000` before, here and in `OPENING_BALANCE`, and nothing measured
 * against it is about its size.
 */

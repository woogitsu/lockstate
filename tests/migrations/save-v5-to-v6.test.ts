...
function v5EnvelopeWithASession(): SaveEnvelopeV5 {
  ...
  const { regimeSchedules: _regimeSchedules, roomFilth: _roomFilth, labourCredit: _labourCredit, delayedIntake: _delayedIntake, pendingCandidateProfiles: _pendingCandidateProfiles, intakeCandidates: _intakeCandidates, holdingStays: _holdingStays, inFlight: _inFlight, ...simulation } = bundle.simulation;
  const payload = {

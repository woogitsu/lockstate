...
describe('declared fallback', () => {
  ...
  it('accounts for every terrain exactly once', () => {
    ...
    expect(coverage.drawn).toEqual(['concrete', 'dirt', 'grass']);
  ...
  it('maps simulation dirt, grass and concrete ids to art and leaves other terrain on colour', () => {
    ...
    expect(terrainFloorSpriteByNumericId(2)).toBeUndefined();

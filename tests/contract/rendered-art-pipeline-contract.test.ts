 ...
 * fields -- `footprintTiles` and `sizePx` -- for every one of the 31 entries,
 ...
 * adds the 29th; the infirmary medical bed adds the 30th; the twin laundry
 * washer adds the 31st. It runs with no Blender,

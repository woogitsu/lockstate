 ...
 *
 *   - `prisoners`: `{count} with no place` (#609, the noun since #961), when
 *     anybody is unhoused
 ...
 * badge's own published number and not on the other. `{count} with no place`
 * renders 15 characters and is published at `+170.5px`; that badge *appears*

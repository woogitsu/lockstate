    ...
    await page.evaluate(
      (model) =>
        window.lockstateUiHarness.reportPendingDeliveries(model, {
          ...
          started: 1,
          orders: [
            { orderId: 'order-00', labelKey: 'hud.build.buildable.wall-brick', tile: { x: 4, y: 4 }, edge: 'north', state: 'in-progress', cancelRefundMinorUnits: 0, revision: 1 },
            { orderId: 'order-01', labelKey: 'hud.build.buildable.wall-brick', tile: { x: 4, y: 5 }, edge: 'north', state: 'assigned', cancelRefundMinorUnits: 80, revision: 1 },
            { orderId: 'order-02', labelKey: 'hud.build.buildable.wall-brick', tile: { x: 4, y: 6 }, edge: 'north', state: 'assigned', cancelRefundMinorUnits: 80, revision: 1 },
          ],

...
describe('every rooted file:line anchor in the documentation is in range', () => {
  ...
  it('still finds the known unresolvable anchors in docs/research/, which it does not police', () => {
    ...
    expect(broken.sort()).toEqual([
      ...
      /*
       * **Eight more of the first shape, and all eight have one cause: ADR
       ...
       */
      'docs/research/2026-08-30-tier-three-at-intake.md -> src/ui/hud/regime-panel.ts:213: out of range, src/ui/hud/regime-panel.ts has 192 lines',
      'docs/research/2026-08-31-what-a-reload-keeps-and-what-it-says.md -> src/ui/hud/regime-panel.ts:647: out of range, src/ui/hud/regime-panel.ts has 192 lines',
      'docs/research/2026-09-02-playing-what-landed-today.md -> src/ui/hud/regime-panel.ts:196-201: out of range, src/ui/hud/regime-panel.ts has 192 lines',
      'docs/research/2026-09-02-the-open-issue-backlog.md -> src/ui/hud/regime-panel.ts:647: out of range, src/ui/hud/regime-panel.ts has 192 lines',
      'docs/research/2026-09-03-what-the-owner-still-owes.md -> src/ui/hud/regime-panel.ts:700-712: out of range, src/ui/hud/regime-panel.ts has 192 lines',
      'docs/research/2026-09-04-hour-two.md -> src/ui/hud/regime-panel.ts:293: out of range, src/ui/hud/regime-panel.ts has 192 lines',
      'docs/research/2026-09-04-is-there-anything-to-do.md -> src/ui/hud/regime-panel.ts:293: out of range, src/ui/hud/regime-panel.ts has 192 lines',
      'docs/research/2026-09-05-where-the-shower-runs-out.md -> src/ui/hud/regime-panel.ts:1370-1372: out of range, src/ui/hud/regime-panel.ts has 192 lines',
    ].sort());
  });
});

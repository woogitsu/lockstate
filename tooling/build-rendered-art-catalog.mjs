...
export const PUBLISHED_ASSET_IDS = [
  ...
  'terrain.dirt.compacted.variant-b',
  'terrain.dirt.compacted.variant-c',
  'terrain.dirt.compacted.variant-d',
  'terrain.grass.mown',
  'terrain.grass.mown.variant-b',
  'terrain.grass.mown.variant-c',
  'terrain.grass.mown.variant-d',
  'terrain.concrete.paving',
  'terrain.gravel.service_path',
  'terrain.rock.bedrock',
  'terrain.water.still',
  'terrain.water.still.variant-b',
  'terrain.water.still.variant-c',
  'terrain.water.still.variant-d',
];

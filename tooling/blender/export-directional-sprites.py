...
ASSAULT_CLIPS = {"idle": (1, 1), "struggle": (4, 8)}
FRAME_SIZE = (256, 384)
FOOT_PIVOT = (128, 352)
...
def main():
    ...
    clips = RESPONSE_CLIPS if args.asset_id == "actor.guard.response" else SEARCH_CLIPS if args.asset_id == "actor.guard.search" else RIOT_CLIPS if args.asset_id == "actor.prisoner.riot" else ASSAULT_CLIPS if args.asset_id == "actor.prisoner.assault" else CLIPS
